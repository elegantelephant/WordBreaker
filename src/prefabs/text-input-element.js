...
export default class TextInputElement extends Phaser.Sprite {
    constructor(game_state, name, position, properties) {
        ...
        this.text_input = new TextInput(this.game_state, this.text_input_name, text_input_pos, properties.text_properties);
